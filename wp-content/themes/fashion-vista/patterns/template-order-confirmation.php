 ...
 * Slug: fashion-vista/template-order-confirmation
...
<h3 class="wp-block-heading" style="font-size:24px"><?php echo esc_html__( 'Order details', 'fashion-vista' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
<h3 class="wp-block-heading" style="font-size:24px"><?php echo esc_html__( 'Downloads', 'fashion-vista' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
<h3 class="wp-block-heading" style="font-size:24px"><?php echo esc_html__( 'Shipping address', 'fashion-vista' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
<h3 class="wp-block-heading" style="font-size:24px"><?php echo esc_html__( 'Billing address', 'fashion-vista' ); ?></h3>
<!-- /wp:heading -->
