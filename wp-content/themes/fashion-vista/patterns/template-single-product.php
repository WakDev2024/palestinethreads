 ...
 * Slug: fashion-vista/template-single-product
...
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:woocommerce/product-gallery {"thumbnailsNumberOfThumbnails":5,"pagerDisplayMode":"off","productGalleryClientId":"4f0e8050-42c5-49a6-9eb6-12e0902527e5"} -->
...
<!-- wp:woocommerce/product-sale-badge {"isDescendentOfSingleProductTemplate":true,"align":"right","lock":{"move":true},"style":{"spacing":{"margin":{"top":"4px","right":"4px","bottom":"4px","left":"4px"}}}} /-->
...
<!-- wp:wc-booster/wish-list-button {"selectedIconColor":"transparent","bgColor":"","position":{"activeUnit":"px","isLinkActive":false,"properties":["top","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[15,20],"tablet":[8,22],"mobile":[8,22]}}} /-->
</div>
...
<!-- wp:wc-booster/usp {"block_id":"wc-booster-usp-block-56754c4f-ddec-45cf-b424-4cc364f8bb29","textColor":"#646464","iconColor":"#1d8516","textTypo":{"fontFamily":"","fontSize":{"units":["px","em","rem"],"activeUnit":"px","values":{"desktop":15,"tablet":15,"mobile":15},"range":{"min":0,"max":100}},"fontWeight":"500","lineHeight":{"activeUnit":"","units":[""],"values":{"desktop":1.5,"tablet":1,"mobile":1},"range":{"min":0,"max":100}}}} /-->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button" style="border-radius:50px"><?php echo esc_html__( 'Buy with Gpay', 'fashion-vista' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<?php echo esc_html__( 'Related products', 'fashion-vista' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:woocommerce/product-image {"isDescendentOfQueryLoop":true,"metadata":{"ignoredHookedBlocks":["wc-booster/wish-list-button","wc-booster/quick-view"]}} /-->
